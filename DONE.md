...
- [2026-04-13 20:03] 使用体验优化：如果没有选择文件，全部刷新和开始同步都相当于默认选择所有的知识库及所有的文 — default-all-kb-when-no-selection
...
- [2026-04-09 16:04] 按钮修复和使用优化：1. 现在全部刷新，强制更新等按钮在批量选择文档后还是灰色不能用 — fix-batch-synced-toolbar-buttons

- [2026-04-09 15:32] 修复：同步任务卡在准备中，点击开始按钮也不会执行。正确的应该直接执行 — fix-pending-sync-task-start

- [2026-04-09 12:33] 使用体验优化：任务应当自动开始，不要我手动点开始，特别是强制更新的任务 — auto-start-force-update-tasks

- [2026-04-09 12:06] 修复：点击强制更新时，界面只有强制更新按钮在转，其他没有任何变化，同步目录中对应的文件会被删掉。正确的应当是点击强制更新后，界面立即将所选的文件都变成未同步状态，然后任务列表里加上同步任务。目前这两者看起来都没有在界面上更新。 — fix-force-update-ui-state-sync
